...
const ALL_PRODUCTS = [
  { id: 1, name: 'Linen Blazer — Oat', price: 189, originalPrice: 240, rating: 4.8, reviews: 312, badge: 'Bestseller', category: 'Women', inStock: true, sizes: ['XS', 'S', 'M', 'L'], colors: ['Oat', 'Black'], image: "https://img.rocket.new/generatedImages/rocket_gen_img_1532036f0-1772156814358.png", alt: 'Cream linen blazer on a wooden hanger, soft natural light' },
