    ...
    <section ref={sectionRef} className="py-20 bg-secondary/40">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-10">
          <div>
            <span className="label-tag text-accent mb-2 block">Curated For You</span>
          ...
          {FEATURED.map((product) => (
            <div
              ...
              <div className="p-4 flex flex-col flex-1">
                ...
                <Link href={`/product-detail?id=${product.id}`}>
                  <h3 className="font-semibold text-foreground text-sm leading-snug mb-2 hover:text-accent transition-colors">
                    {product.name}
                  </h3>
                </Link>
                    ...
                    <>
                      <div className="flex gap-2">
                        <button
                          ...
                          className="flex-1 flex items-center justify-center gap-1.5 py-2 px-3 rounded-xl bg-secondary border border-border text-foreground text-xs font-semibold hover:bg-accent hover:text-white hover:border-accent transition-all duration-200">
                      ...
                      <Link
                        ...
                        className="flex items-center justify-center gap-1.5 w-full py-2 px-3 rounded-xl bg-accent text-white text-xs font-bold uppercase tracking-wider hover:bg-accent-dark transition-all duration-200">
